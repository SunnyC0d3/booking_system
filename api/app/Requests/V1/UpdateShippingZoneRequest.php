...
class UpdateShippingZoneRequest extends BaseFormRequest
{
    ...
    {
        $zoneId = $this->route('shippingZone')?->id ?? 'null';

        return [
            'name' => ['sometimes', 'required', 'string', 'max:255', 'unique:shipping_zones,name,' . $zoneId],
            'description' => ['nullable', 'string', 'max:1000'],
            'countries' => ['sometimes', 'required', 'array', 'min:1'],
