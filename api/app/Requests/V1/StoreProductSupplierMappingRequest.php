...
class StoreProductSupplierMappingRequest extends BaseFormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'is_primary' => 'boolean',
            'is_active' => 'boolean',
            'priority_order' => 'integer|min:1|max:999',
            ...
            'minimum_stock_threshold' => 'integer|min:0|max:1000',
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'auto_update_price' => $this->boolean('auto_update_price', true),
            'auto_update_stock' => $this->boolean('auto_update_stock', true),
            'auto_update_description' => $this->boolean('auto_update_description', false),
        ]);
