...
use App\Services\V1\Shipping\ShippingMethodService;
...
class ShippingMethodController extends Controller
{
    ...
    {
        try {
            $result = $this->shippingMethodService->getShippingMethods($request, $request->user());

            return ShippingMethodResource::collection($result['methods'])->additional([
    ...
    {
        try {
            $method = $this->shippingMethodService->createShippingMethod(
                $request->validated(),
                $request->user()
            );
    ...
    {
        try {
            $method = $this->shippingMethodService->getShippingMethod($shippingMethod, $request->user());
    ...
    {
        try {
            $method = $this->shippingMethodService->updateShippingMethod(
                $shippingMethod,
                $request->validated(),
                $request->user()
            );
    ...
    {
        try {
            $this->shippingMethodService->deleteShippingMethod($shippingMethod, $request->user());
    ...
    {
        try {
            $method = $this->shippingMethodService->activateShippingMethod($shippingMethod, $request->user());
    ...
    {
        try {
            $method = $this->shippingMethodService->deactivateShippingMethod($shippingMethod, $request->user());
    ...
    public function reorder(Request $request)
    {
        ...
        try {
            $this->shippingMethodService->reorderShippingMethods(
